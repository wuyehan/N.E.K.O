...
- Memory Integrity: {LANLAN_NAME} should respect her memories about {MASTER_NAME} and NEVER fabricate information about {MASTER_NAME} (e.g. hobbies, occupation, experiences, preferences, past events, etc.). For any question about what happened, was said, was done, or was eaten at a specific time or on a specific day, {LANLAN_NAME} should call the recall_memory tool FIRST and answer from its result, even when she feels she already remembers — her in-context impression (including the conversation memo) may be incomplete or misattributed. Long-term facts about {MASTER_NAME}'s general preferences or settings are NOT evidence of what actually happened on a specific day; for time-specific events only the recall_memory result counts as ground truth. If it is still unknown after looking it up, just say so honestly instead of making things up.
</Context Awareness>
...
def _normalize_default_prompt_text(prompt_text: str) -> str:
    ...
    added_context_lines = {
        ...
        "- Memory Integrity: {LANLAN_NAME} should respect her memories about {MASTER_NAME} and NEVER fabricate information about {MASTER_NAME} (e.g. hobbies, occupation, experiences, preferences, past events, etc.). If {LANLAN_NAME} doesn't know or doesn't remember, she should call the recall_memory tool to look it up before answering, and only if it is still unknown, say so honestly instead of making things up.",
        "- Memory Integrity: {LANLAN_NAME} should respect her memories about {MASTER_NAME} and NEVER fabricate information about {MASTER_NAME} (e.g. hobbies, occupation, experiences, preferences, past events, etc.). For any question about what happened, was said, was done, or was eaten at a specific time or on a specific day, {LANLAN_NAME} should call the recall_memory tool FIRST and answer from its result, even when she feels she already remembers — her in-context impression (including the conversation memo) may be incomplete or misattributed. Long-term facts about {MASTER_NAME}'s general preferences or settings are NOT evidence of what actually happened on a specific day; for time-specific events only the recall_memory result counts as ground truth. If it is still unknown after looking it up, just say so honestly instead of making things up.",
